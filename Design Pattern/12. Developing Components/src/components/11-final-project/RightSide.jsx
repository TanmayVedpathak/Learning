...
import { Columns, Column } from "../3-column-pattern/InfoFormWithColumns";
      ...
      <Pad as="section" padding="l">
        <Layers gutter="l">
          <Layers as="header" gutter="l">
            ...
            <SubLabel>These information will be required for the basic varification of profile.</SubLabel>
          </Layers>
