...
const Profile = () => {
  return (
    <Center as={Layers} gutter="xl" centerChildren centerText maxWidth="60ch">
      <h2>I am title!</h2>
      <p>"This is a long long text , nibh lorem convenire quo et. Usu ea libris omittantur. Dicta theophrastus ad mei. Dicat appetere at vis, I am the end of text."</p>
      <Extras />
    </Center>
  );
};
