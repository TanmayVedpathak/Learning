...
const ShoppingListRow = (props) => {
  ...
  return (
    <StyledContainer>
      <StyledInputContainer>{isEditing ? <StyledInput type="text" value={name} onChange={(e) => setName(e.target.value)} /> : <StyledText>{item.name}</StyledText>}</StyledInputContainer>
