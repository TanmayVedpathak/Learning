...
const SkeletonLoading = lazy(() => import("./skeleton-loading/SkeletonLoading"));

export { Home, Form, HookForm, Callback, VirtualList, CreatePostPage, PostDetailsPage, PostsPage, SkeletonLoading };
